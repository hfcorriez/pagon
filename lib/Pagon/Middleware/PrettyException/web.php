...
<div id="kohana_error">
    ...
    <div id="<?php echo $error_id ?>" class="content">
        ...
        <?php echo \Pagon\Helper\Debug::source($file, $line) ?>
        <ol class="trace">
            <?php foreach (\Pagon\Helper\Debug::trace($trace) as $i => $step): ?>
            <li>
                <p>
					<span class="file">
                ...
                <div id="<?php echo $args_id ?>" class="collapsed">
                    <table cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td><pre><?php echo \Pagon\Helper\Debug::dump($arg) ?></pre></td>
                        </tr>
                        <?php endforeach ?>
                    </table>
                </div>
        ...
        <div id="<?php echo $env_id ?>" class="collapsed">
            <table cellspacing="0">
                ...
                <tr>
                    ...
                    <td><pre><?php echo \Pagon\Helper\Debug::dump($value) ?></pre></td>
                </tr>
                <?php endforeach ?>
            </table>
        </div>
