...
<head>
    ...
    <style type="text/css">
        ...
        body {
            font: 500 0.875em/1.8 Helvetica Neue, Microsoft Yahei, Hiragino Sans GB, WenQuanYi Micro Hei, sans-serif;
            *width: auto;
            *overflow: visible;
            line-height: 22px;
        }
        ...
        body h1 {
            font: 38px/1.8em Helvetica Neue, Microsoft Yahei, Hiragino Sans GB, WenQuanYi Micro Hei, serif !important;
        }
        ...
        .button {
            ...
            color: #fff;
            padding: 10px;
            font-family: Hiragino Sans GB, WenQuanYi Micro Hei, serif !important;
        }
