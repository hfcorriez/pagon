...
class MimeType
{
    ...
    {
        return isset(self::$mime_types[$type]) ? self::$mime_types[$type][0] : null;
    }
    ...
    {
        return isset(self::$mime_types[$type]) ? self::$mime_types[$type] : null;
    }
     ...
     * @return bool|string
     */
    public static function id($mime_type)
    {
        foreach (self::$mime_types as $id => $current_mime_types) {
            if (in_array($mime_type, $current_mime_types)) {
                return $id;
            }
        }
        return false;
